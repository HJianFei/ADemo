...
import com.apace.ydimall.constants.Constants;
 ...
 *     time   : 2017-08-09
 *     desc   : DES加密解密，先用DES加密，再用Base64加密；先用Base64解密，再用DES解密；
 *     version: 1.0
 * </pre>
 */
...
public class DESUtils {
    ...
    public static String encryptDES(String encryptString) {
        return encryptDES(encryptString, Constants.DES_KEY);
    }

    public static byte[] encryptDES(byte[] encryptString) {
        return encryptDES(encryptString, Constants.DES_KEY);
    }
    ...
    public static String decryptDES(String decryptString) {
        ...
        return decryptDES(decryptString, Constants.DES_KEY);
    }

    public static byte[] decryptDES(byte[] decryptString) {
